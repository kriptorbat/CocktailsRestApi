...
public class Controller {
    ...
    public List<Cocktail> getCocktails() throws ExecutionException, InterruptedException, IOException {
        FirebaseConfig firebase = new FirebaseConfig();
        firebaseRepository = new FirebaseRepository(firebase);
        // Создание тестовых данных
        List<Cocktail> cocktails = new ArrayList<>();
        cocktails = firebaseRepository.getCocktails();
